...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMill) {
                ...
                // Hours
                append("\t ${it.endTimeMilli.minus(it.startTimeMill) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeMilli.minus(it.startTimeMill) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeMilli.minus(it.startTimeMill) / 1000}<br><br>")
            }
        }
    }
